...
### Dropdown multi-select with icons

Use icons inside each option to help users quickly scan and differentiate the selected chips even when multiple rows are displayed.

<Canvas of={DropdownStories.DropdownMultiSelectWithIcons} />
