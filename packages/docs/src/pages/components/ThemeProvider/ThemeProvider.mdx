...
System theme is a one of a 4 predefined themes: <code>light</code>(<code>.light-app-theme</code>), <code>dark</code>(<code>.dark-app-theme</code>), <code>black</code>(<code>.black-app-theme</code>) and <code>pink</code>(<code>.pink-app-theme</code>).
...
There are 4 system themes <code>light</code>, <code>dark</code>, <code>black</code> and <code>pink</code>, and in each you can redefine the values of the following color tokens:
