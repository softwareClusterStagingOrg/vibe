import{j as o}from"./jsx-runtime-lwGtIXvq.js";import{r as s}from"./index-CTZeEbLr.js";import{u as m}from"./index-BlWfPOxY.js";import{F}from"./Flex-Bimzf4jb.js";import{B as g}from"./Button-DTKYqLJ4.js";const v={title:"Hooks/useListenFocusTriggers"},e={render:()=>{const[a,t]=s.useState("-"),n=s.useRef(null),i=s.useCallback(d=>{t("mouse")},[]),l=s.useCallback(d=>{t("keyboard")},[]);return m({ref:n,onFocusByMouse:i,onFocusByKeyboard:l}),o.jsxs(F,{direction:"column",gap:"medium",align:"start",children:[o.jsx(g,{ref:n,children:"Focus target"}),o.jsxs("div",{children:["Received focus by: ",a]})]})},name:"Overview"};var r,u,c;e.parameters={...e.parameters,docs:{...(r=e.parameters)==null?void 0:r.docs,source:{originalSource:`{
  render: () => {
